...
continuar = 'y'
correcto = True
p_level = 10 # Se inicializa pero se pide al usuario
...
while correcto and n_pregunta < 3*p_level:
    ...
    if n_pregunta == 0:
        ...
        # Convertir a int para validar, las opciones son '1', '2', '3'
    ...
    if continuar == 'y':
        ...
        if correcto and n_pregunta < 3*p_level:
            ...
            time.sleep(3)
            os.system(op_sys)
            sys.exit() # Termina el programa si gana
        else: 
            print(f'Lo siento, conseguiste {n_pregunta - 1} respuestas correctas,\n Sigue participando!!')
            time.sleep(3)
            os.system(op_sys)
            exit() # Termina el programa si pierde
    else:
        print('Nos vemos pronto!')
        time.sleep(2)
        os.system(op_sys)
        sys.exit() # Termina el programa si no desea continuar
